# -*- coding: utf-8 -*-
"""Web_ad_optimization.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Ps0UA3nzb9p83dw4wOQ6ADP7vQd9-NAI
...
dataset = pd.read_excel('Book 1 (3).xlsx')
print(dataset.shape)
...
for n in range(0, observations):
  ...
  numbers_of_selections_of_each_ads[ad] = numbers_of_selections_of_each_ads[ad]
